...
int main()
{
    ...
    Shader shaderLight("src/shader.vs", "src/shader_light.fs");
    Shader shaderBlur("src/shader_blur.vs", "src/shader_blur.fs");
    Shader shaderBloomFinal("src/shader_final.vs", "src/shader_final.fs");
